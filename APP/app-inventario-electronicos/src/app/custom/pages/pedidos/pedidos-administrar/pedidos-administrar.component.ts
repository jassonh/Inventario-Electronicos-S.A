...
@Component({
  selector: 'app-pedidos-administrar',
  templateUrl: './pedidos-administrar.component.html',
  styleUrls: [
    './pedidos-administrar.component.scss',
    '../../../../../../node_modules/ng2-toasty/style-bootstrap.css',
    '../../../../../assets/icon/icofont/css/icofont.scss'
  ],
  encapsulation: ViewEncapsulation.None
})
export class PedidosAdministrarComponent implements OnInit {
  ...
  find() {
    ...
    let result = fetch(`${environment.apiUrl}/pedido`, {
      method: 'GET',
      headers: {
