...
@Component({
  selector: 'app-sucursales-administrar',
  templateUrl: './sucursales-administrar.component.html',
  styleUrls: [
    './sucursales-administrar.component.scss',
    '../../../../../../node_modules/ng2-toasty/style-bootstrap.css',
    '../../../../../assets/icon/icofont/css/icofont.scss'
  ],
  encapsulation: ViewEncapsulation.None
})
export class SucursalesAdministrarComponent implements OnInit {
  ...
  find() {
    ...
    let result = fetch(`${environment.apiUrl}/sucursal`, {
      method: 'GET',
      headers: {
