...
@Component({
  selector: 'app-ventas-administrar',
  templateUrl: './ventas-administrar.component.html',
  styleUrls: [
    './ventas-administrar.component.scss',
    '../../../../../../node_modules/ng2-toasty/style-bootstrap.css',
    '../../../../../assets/icon/icofont/css/icofont.scss'
  ],
  encapsulation: ViewEncapsulation.None
})
export class VentasAdministrarComponent implements OnInit {
  ...
  find() {
    ...
    let result = fetch(`${environment.apiUrl}/venta`, {
      method: 'GET',
      headers: {
